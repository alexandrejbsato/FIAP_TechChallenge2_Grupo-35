...
class UserTypeRestaurantIntegrationTest {
    ...
    void fullFlow_createUserType_createUser_assignType_createRestaurant() {
        ...
        ResponseEntity<Map> utResp = restTemplate.postForEntity("/api/v1/user-types", userTypeReq, Map.class);
        ...
        ResponseEntity<Map> userResp = restTemplate.postForEntity("/api/v1/users", userReq, Map.class);
        ...
        ResponseEntity<Map> loginResp = restTemplate.postForEntity("/api/v1/users/login", loginReq, Map.class);
        ...
        ResponseEntity<Map> assignResp = restTemplate.exchange("/api/v1/users/" + userId + "/user-type", HttpMethod.PATCH, assignEntity, Map.class);
        ...
        ResponseEntity<Map> restoResp = restTemplate.postForEntity("/api/v1/restaurants", restoEntity, Map.class);
        ...
        ResponseEntity<Map> getResp = restTemplate.exchange("/api/v1/restaurants/" + restoId, HttpMethod.GET, getEntity, Map.class);
